...
signTxByProto = async function (mnemonic, hdPath, chainId, stdSignMsg) {
    ...
    if (chainId.indexOf("cosmos") != -1) {
        ...
        prefix = "stars";
    } else if (chainId.indexOf("desmos") != -1) {
        prefix = "desmos";
    } else if (chainId.indexOf("axelar") != -1) {
        prefix = "axelar";
    } else if (chainId.indexOf("gravity-bridge") != -1) {
        prefix = "gravity";
    } else if (chainId.indexOf("lum") != -1) {
        prefix = "lum";
    } else if (chainId.indexOf("chihuahua") != -1) {
        prefix = "chihuahua";
    } else if (chainId.indexOf("secret") != -1) {
        prefix = "secret";
    } else if (chainId.indexOf("axelar") != -1) {
        ...
        prefix = "cre";
    } else if (chainId.indexOf("mantle") != -1) {
        prefix = "mantle";
    } else if (chainId.indexOf("meme") != -1) {
	prefix = "meme";
    }
